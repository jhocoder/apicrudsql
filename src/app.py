...
client = MongoClient("mongodb://host.internal.docker:37017") #aca me conecto a mongo contenedor POR TIEMPO ME ATRASE
## PARA CONECTARME A UNA BD POBLAD
##  docker run -d  -p 47017:27017 --name mongoejercicio2 mongo -v mongo-data:/data/db
## luego crear un commit usar esa imagen y arrancar otro contenedor con esa imagen mapeando la misma carpeta y haciendo un push actualizado
